...
<body>
	...
	<nav
		...
		<a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">Inspirations and Ideas for Bucketlist</a>
...
<%
	...
	PreparedStatement ps=con.prepareStatement("select * from inspiration");
